...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tools.getSharedPreferenceString(this, "isLogin", "").equals("1")) {
            finish();
        ...
        lupapassword.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lupa= new Intent(Login.this, Lupa_password.class);
                startActivity(lupa);
            }
        });
                                            ...
                                            if (task.isSuccessful()) {
                                                for (QueryDocumentSnapshot document : task.getResult()) {
                                                    ...
                                                    if (document.getData().get("email").equals(email1)){
                                                        tools.setSharedPreference(Login.this,"level", document.getData().get("level").toString());
                                                        tools.setSharedPreference(Login.this,"bpjs", document.getData().get("bpjs").toString());
                                                        tools.setSharedPreference(Login.this,"nik", document.getData().get("nik").toString());
                                                        tools.setSharedPreference(Login.this,"nama", document.getData().get("nama").toString());
                                                        tools.setSharedPreference(Login.this,"isLogin", "1");
                                                        tools.setSharedPreference(Login.this,"email", email1);
                                                        tools.setSharedPreference(Login.this,"foto", document.getData().get("foto").toString());
                                                        finish();
                                                        Intent intent = new Intent(Login.this, Nav_Home.class);
                                                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                        startActivity(intent);
